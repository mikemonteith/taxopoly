...
export function Footer() {
  return (
    <footer className="flex items-center justify-center gap-6 border-t py-4 text-sm text-muted-foreground">
      <a
        href="https://github.com/mikemonteith/taxopoly"
        target="_blank"
